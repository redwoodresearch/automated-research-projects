"""Segment 15 (mech_tokens_prompting) — P2 analysis: WHICH instruction tokens.
...
def main():
    ...
    md = ["# P2 — WHICH instruction tokens the recruited late heads attend to, and which are NECESSARY\n",
    ...
    md.append("\n**Read:** % REMOVED = (steered marker logit − masked marker logit) / (steered − base). "
              "`mask_whole` ≈ 100% (replicates P1). The question is whether **spec** alone removes most "
