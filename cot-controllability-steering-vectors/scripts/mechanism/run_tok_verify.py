"""Segment 15 (mech_tokens_prompting) — P1: BROADEN the Seg-11 onset attention-gating verdict.
...
48 tasks vs Seg-11's 12) × the held-out FORMATTING + casing instructions (bullet/numbered/
