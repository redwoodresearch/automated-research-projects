"""Segment 11 (mech_interp) — P2.5: QK-pattern vs OV-value patching (the central modulation-vs-
gated-additive test) + sub-block ablation (P4.7 necessity) + a SURGICAL instruction-attention
