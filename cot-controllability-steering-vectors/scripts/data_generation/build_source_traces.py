"""Stage A of the edited-reasoning SFT build (Segment 3): assemble + QUALIFY the source traces.

For each base-solvable TRAIN task we recover the model's **natural base ``analysis``** (generated with
NO reasoning instruction, answer-format only, medium/greedy/seed-0) from the cached Segment-1 base
