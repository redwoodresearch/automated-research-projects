"""Stage B of the edited-reasoning SFT build (Segment 3): build the COMPLIANT SFT targets.
...
# Meta gate: use Opus across the board. The validated Haiku meta judge (Segment-2 precision ~0.93)
...
# and yields meaningful rejects. STRONG handoff recommendation: the Segment-5 eval should also use
