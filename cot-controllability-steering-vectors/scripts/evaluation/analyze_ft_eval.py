...
(Segment 4, Priority 3 step 8). FAST (no API calls; recomputes programmatic scorers from text).
...
from sft_edit import is_degenerate  # noqa: E402  (reuse the Segment-3 loop/repetition detector)
...
def effective(row):
    ...
    # effective_control (reuses the Segment-3 detector).
