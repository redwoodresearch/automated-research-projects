"""Deliverable #2 analysis (Segment 8): the full-n, significance-tested held-out steering eval.

Reads the JUDGED steered deliverable eval (base + gL10 + trained-on-control twin gL10ctrl + seeds
gL10_s1/_s2), the JUDGED random-matched-norm null eval (>=5 seeds), and the Segment-5 FT deliverable
...
def main():
    ...
    L.append(f"\n## Multi-seed robustness (headline = seed 0 `{main}`; the Seg-7-conservative pick — "
