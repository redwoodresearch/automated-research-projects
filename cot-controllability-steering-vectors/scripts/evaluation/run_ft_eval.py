"""Preliminary held-out CoT-compliance eval: FT model vs MATCHED base (Segment 4, Priority 3).
...
# 'smoke' = the exact Segment-4 c32 preliminary eval (kept byte-reproducible).
EVAL_PRESETS = {
