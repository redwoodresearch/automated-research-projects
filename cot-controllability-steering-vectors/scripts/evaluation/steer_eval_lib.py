"""Shared steered-eval machinery for Segment 6 (VAL sweep + held-out eval).

Reuses the Segment-5 eval conventions (per-source max_new_tokens + 8192 truncation recovery,
