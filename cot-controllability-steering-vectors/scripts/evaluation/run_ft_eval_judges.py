"""Run the LLM judges over the FT held-out eval (Segment 4, Priority 3 step 8).

CRITICAL judge-model policy (from the Segment-3 finding): the Haiku meta judge OVER-FLAGS complying/
...
def main():
    ...
    # reasoning -> would understate the uplift; Segment-4 finding). terse_25w is the within-bucket
